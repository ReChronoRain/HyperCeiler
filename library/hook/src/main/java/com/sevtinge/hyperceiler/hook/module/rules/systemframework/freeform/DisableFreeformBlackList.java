...
*/
package com.sevtinge.hyperceiler.hook.module.rules.systemframework.freeform;
...
public class DisableFreeformBlackList extends BaseHook {
    ...
    public void init() {
        if (isMoreAndroidVersion(36)) {
            ...
            hookAllMethods(mMiuiFreeformServiceImpl, "setFreeformBlackList", new MethodHook() {
                @Override
            ...
            findAndHookMethod(mMiuiFreeformServiceImpl, "isForceResizeable", XC_MethodReplacement.returnConstant(true));
