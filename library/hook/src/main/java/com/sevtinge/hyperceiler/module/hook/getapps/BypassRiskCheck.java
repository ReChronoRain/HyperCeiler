...
public class BypassRiskCheck extends BaseHook {
    ...
    public void init() throws NoSuchMethodException {
        ...
        if (isNew) {
            ...
            findAndHookMethod("com.xiaomi.market.common.component.componentbeans.AppSecurityCheckRules$Companion", "getTotalResult", "com.xiaomi.market.common.component.componentbeans.AppSecurityCheckRules", int.class, int.class, new MethodHook() {
                @Override
                protected void before(MethodHookParam param) throws Throwable {
            ...
            findAndHookMethod("com.xiaomi.market.business_ui.main.mine.app_security.AppSecurityCheckManager", "getRiskResultTxtByMine", int.class, int.class, new MethodHook() {
                @Override
                protected void before(MethodHookParam param) throws Throwable {
                    param.args[1] = 0;
                }
