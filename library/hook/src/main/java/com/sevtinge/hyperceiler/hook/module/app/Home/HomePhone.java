...
import com.sevtinge.hyperceiler.hook.module.rules.home.gesture.QuickBackNew;
...
@HookBase(targetPackage = "com.miui.home", deviceType = 2, minOSVersion = 3f)
public class HomePhone extends BaseModule {

    @Override
    public void handleLoadPackage() {
        // 手势
        initHook(new DisableFullScreenBackGesture(), mPrefsMap.getBoolean("home_navigation_disable_full_screen_back_gesture"));
        initHook(QuickBackNew.INSTANCE, mPrefsMap.getBoolean("home_navigation_quick_back"));
