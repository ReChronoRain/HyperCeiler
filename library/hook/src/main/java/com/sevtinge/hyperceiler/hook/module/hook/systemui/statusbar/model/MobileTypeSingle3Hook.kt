...
object MobileTypeSingle3Hook : BaseHook() {
    ...
    private fun hookMobileViewAndVM() {
        ...
        modernStatusBarMobileView.methodFinder()
            ...
            .single().createAfterHook { param ->
                ...
                // 添加大 5G 并设置样式
                if (showMobileType) {
                    val mobileType = container.findViewByIdName("mobile_type") as? ImageView
                    ...
                    // 大 5G 始终删除小 5G
                    container.removeView(mobileType)
                }
                        ...
                        MiuiStub.javaAdapter.alwaysCollectFlow(
                            ...
                            Consumer<Boolean> {
                                if (subId == SubscriptionManager.getDefaultDataSubscriptionId()) {
                                    ...
                                    container.setPadding(if (!it) 0 else paddingLeft, 0, 0, 0)
    ...
    private fun setSubId(
        ...
        if (subId == SubscriptionManager.getDefaultDataSubscriptionId()) {
            ...
            if (!showMobileType) {
                ...
                container.setPadding(if (!isNoDataConnected) 0 else paddingLeft, 0, 0, 0)
                container.setPadding(paddingLeft, 0, 0, 0)
            }
