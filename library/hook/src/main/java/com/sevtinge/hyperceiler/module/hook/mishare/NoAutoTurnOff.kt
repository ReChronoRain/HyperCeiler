...
object NoAutoTurnOff : BaseHook() {
    ...
    override fun init() {
        ...
        if (isMoreHyperOSVersion(2f)) {
            hookMethod(stopAdvertAllMethod, object : com.sevtinge.hyperceiler.module.base.tool.HookTool.MethodHook() {
            ...
            runCatching {
                findAndHookConstructor(nullField.javaClass, object : com.sevtinge.hyperceiler.module.base.tool.HookTool.MethodHook() {
            ...
            try {
                runCatching {
                    hookMethod(null2FieldMethod, object : com.sevtinge.hyperceiler.module.base.tool.HookTool.MethodHook() {
                        override fun before(param: MethodHookParam) {
        ...
        if (toastMethod.isNotEmpty()) {
            toastMethod.createHooks {
                before { param ->
                    _root_ide_package_.com.sevtinge.hyperceiler.module.base.tool.HookTool.findAndHookMethod(
                        Context::class.java,
                        "getString",
                        Int::class.java,
            ...
            hookMethod(showToastMethod, object : com.sevtinge.hyperceiler.module.base.tool.HookTool.MethodHook() {
