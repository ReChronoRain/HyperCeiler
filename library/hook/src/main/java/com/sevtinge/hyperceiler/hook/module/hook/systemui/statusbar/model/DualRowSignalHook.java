...
public class DualRowSignalHook extends BaseHook {
    ...
    public void init() {
         if (!mobileTypeSingle) {
            setDensityReplacement("com.android.systemui", "dimen", "status_bar_mobile_type_half_to_top_distance", 3);
            setDensityReplacement("com.android.systemui", "dimen", "status_bar_mobile_left_inout_over_strength", 0);
