...
object UnlockMoreVolumeFromNew : BaseHook() {
    ...
    override fun init() {
        ...
        findAndHookConstructor(getClass, object : com.sevtinge.hyperceiler.module.base.tool.HookTool.MethodHook() {
        ...
        hookMethod(bothRecordMethod, object : com.sevtinge.hyperceiler.module.base.tool.HookTool.MethodHook() {
