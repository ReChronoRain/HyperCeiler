...
public class DialogGravity extends BaseHook {
    ...
    final Class<?> mDialogCls = findClassIfExists("miuix.appcompat.app.AlertController", getClassLoader());
    final Class<?> mDialogParentPanelCls = findClassIfExists("miuix.internal.widget.DialogParentPanel", getClassLoader());
