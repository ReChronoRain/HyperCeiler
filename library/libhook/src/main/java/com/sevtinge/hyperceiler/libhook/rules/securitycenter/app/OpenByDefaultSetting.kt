...
class OpenByDefaultSetting : BaseHook() {
    ...
    companion object {
        ...
        private fun openDefaultOnClick(activity: Activity) {
            ...
            XposedLog.d("OpenByDefaultSetting open default: $pkgName")
    ...
    override fun init() {
        ...
        if (Activity::class.java.isAssignableFrom(appDetailsView)) {
            ...
            // injectClassLoader()
            findAndHookMethod(appDetailsView,
                "onPreferenceClick",
    ...
    fun injectClassLoader() {
        ...
        fParent.set(self, object : ClassLoader(sBootClassLoader) {
            ...
            override fun findClass(name: String?): Class<*> {
                XposedLog.d(TAG, lpparam.packageName, "OpenByDefaultSetting findClass $name")
                try {
