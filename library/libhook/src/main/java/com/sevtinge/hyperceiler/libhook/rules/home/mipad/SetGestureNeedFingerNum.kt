    ...
    override fun init() {
        ...
        clazzGestureOperationHelper.methodFinder()
            ...
            .first().createBeforeHook { param ->
                ...
                val flagSwipeLeft =
                    clazzGestureOperationHelper.getStaticObjectFieldAsOrNull<Int>("SWIPE_DIRECTION_LEFT")
                val flagSwipeRight =
                    clazzGestureOperationHelper.getStaticObjectFieldAsOrNull<Int>("SWIPE_DIRECTION_RIGHT")
