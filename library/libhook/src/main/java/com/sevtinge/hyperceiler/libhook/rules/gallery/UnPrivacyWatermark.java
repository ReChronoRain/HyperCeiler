...
public class UnPrivacyWatermark extends BaseHook {
    ...
    public void drawWatermark(Canvas canvas, String text, int mWidth, int mHeight, int angle, boolean is) {
        // XposedLog.e(TAG, "can: " + canvas + " text: " + text + " wid: " + mWidth + " hei: " + mHeight + " an: " + angle);
        int i4 = 0;
        int i5 = 0;
        int i6 = mWidth;
        ...
        float f2 = 7.0f * min;
        Paint initialPaint = (Paint) callStaticMethod(findClass(is ? "com.miui.gallery.editor.photo.app.privacy.PrivacyWatermarkHelper" : "com.miui.gallery.privacywatermark.PrivacyWatermarkHelper"), "getInitialPaint");
        Rect rect = new Rect();
        ...
        if (angle != 90) {
            if (angle == 180) {
                ...
                if (angle != 0) {
                    XposedLog.e(TAG, "Not standard orientation degree: " + angle);
                }
                i4 = (int) (mHeight * max);
        ...
        while (i7 <= i4) {
            ...
            // XposedLog.e(TAG, "i7: " + i7 + " re: " + rect.height() + " wid: " + width + " i4: " + i4);
            i8 = i8 - height;
        }
    }
}
