...
import com.sevtinge.hyperceiler.libhook.utils.hookapi.systemui.controlcenter.MediaControlBgFactory.conColorScheme2
import com.sevtinge.hyperceiler.libhook.utils.hookapi.systemui.controlcenter.MediaControlBgFactory.conColorScheme3
import com.sevtinge.hyperceiler.libhook.utils.hookapi.systemui.controlcenter.MediaControlBgFactory.defaultColorConfig
import com.sevtinge.hyperceiler.libhook.utils.hookapi.systemui.controlcenter.MediaControlBgFactory.enumStyleContent
...
import com.sevtinge.hyperceiler.libhook.utils.hookapi.systemui.controlcenter.MediaControlBgFactory.getWallpaperColor
...
import com.sevtinge.hyperceiler.libhook.utils.hookapi.systemui.controlcenter.mediabackground.BgProcessor
import com.sevtinge.hyperceiler.libhook.utils.hookapi.systemui.controlcenter.mediabackground.BlurredCoverProcessor
import com.sevtinge.hyperceiler.libhook.utils.hookapi.systemui.controlcenter.mediabackground.CoverArtProcessor
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            if (wallpaperColors != null) {
                ...
                try {
                    ...
                    XposedLog.w(TAG, lpparam.packageName, "updateBackground(method) application not found!")
                    return@launch
                }
            }
