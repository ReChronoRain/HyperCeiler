...
import static io.github.kyuubiran.ezxhelper.xposed.api.XposedApi.getRemotePreferences;
...
public class CorePatchHelper {
    ...
    public static final SharedPreferences prefs = getRemotePreferences(PrefsBridge.PREFS_NAME + "_remote");
