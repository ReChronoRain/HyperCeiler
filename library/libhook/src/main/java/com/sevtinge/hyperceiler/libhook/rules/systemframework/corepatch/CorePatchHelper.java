...
public class CorePatchHelper {
    ...
    public static final String PREF_AUTH_CREAK = "prefs_key_system_framework_core_patch_auth_creak";
    public static final String PREF_DIGEST_CREAK = "prefs_key_system_framework_core_patch_digest_creak";
    public static final String PREF_USE_PRE_SIGNATURE = "prefs_key_system_framework_core_patch_use_pre_signature";
    public static final String PREF_EXACT_SIGNATURE_CHECK = "prefs_key_system_framework_core_patch_exact_signature_check";
    public static final String PREF_SHARED_USER = "prefs_key_system_framework_core_patch_shared_user";
    public static final String PREF_DISABLE_VERIFICATION_AGENT = "prefs_key_system_framework_disable_verification_agent";
    ...
    public static boolean isFeatureEnabled(String key, boolean defValue) {
        return PrefsBridge.getBoolean(key, defValue);
    }

    public static boolean isUsePreSignatureEnabled() {
        return isFeatureEnabled(PREF_DIGEST_CREAK, true)
            && isFeatureEnabled(PREF_USE_PRE_SIGNATURE, false);
    }

    public static boolean isSharedUserEnabled() {
        return isFeatureEnabled(PREF_DIGEST_CREAK, true)
            && isFeatureEnabled(PREF_SHARED_USER, false);
    }
