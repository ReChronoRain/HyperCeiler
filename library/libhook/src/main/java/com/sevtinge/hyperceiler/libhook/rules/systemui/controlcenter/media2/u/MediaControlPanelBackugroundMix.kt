...
*/
package com.sevtinge.hyperceiler.libhook.rules.systemui.controlcenter.media2.u
...
import com.sevtinge.hyperceiler.libhook.utils.hookapi.systemui.controlcenter.PublicClass.notificationUtil
...
class MediaControlPanelBackgroundMix : BaseHook() {
        ...
        runCatching {
            ...
            miuiMediaControlPanel?.methodFinder()?.filterByName("bindPlayer")?.first()
                ?.createAfterHook {
                    ...
                    val isBackgroundBlurOpened =
                        callStaticMethod(notificationUtil, "isBackgroundBlurOpened", context)
                            as Boolean
            ...
            playerTwoCircleView?.methodFinder()?.filterByName("onDraw")?.first()
                ?.createBeforeHook {
                    ...
                    val getLazyClass = callMethod(mStatusBarStateController, "get")
                    val getState = callMethod(getLazyClass, "getState")
    ...
    private fun getNotificationElementBlendColors(context: Context, isInLockScreen: Boolean, darkMode: Boolean): IntArray? {
        ...
        try {
            ...
            XposedLog.w(TAG, "Notification element blend colors not found [1/3]!")
        }
        ...
        try {
            ...
            XposedLog.w(TAG, "Notification element blend colors not found [2/3]!")
        }
        ...
        try {
            ...
            XposedLog.w(TAG, "Notification element colors not found [3/3]!")
        }

        XposedLog.e(TAG, "Notification element blend colors not found!")
        return null
    }
