...
public class ReduceBrightColorsTile extends TileUtils {
    ...
    protected TileConfig onCreateTileConfig() {
        return new TileConfig.Builder()
            .setTileClass(findClassIfExists("com.android.systemui.qs.tiles.ReduceBrightColorsTile"))
            .setIcons(R.drawable.ic_reduce_bright_colors, R.drawable.ic_reduce_bright_colors)
            .build();
    }
}
