...
object SidebarLineCustom : BaseHook() {
    ...
    override fun init() {
        ...
        XposedLog.i(TAG, "com.miui.securitycenter", "mSidebarLineColorDark is $mSidebarLineColorDark")
        XposedLog.i(TAG, "com.miui.securitycenter", "mSidebarLineColorLight is $mSidebarLineColorLight")
        setResReplacement(
            "com.miui.securitycenter",
            "color",
            "sidebar_line_color",
