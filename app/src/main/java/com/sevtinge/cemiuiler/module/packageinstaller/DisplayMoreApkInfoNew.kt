        ...
        if (mAppInfoViewObject != null) {
            ...
            if (methods.isNotEmpty()) {
                ...
                methods[0].hookAfterMethod { hookParam ->
                    ...
                    mAppVersionNameView.text = moduleRes.getString(R.string.various_install_app_info_version_name) + ": " + mAppVersionName
                    mAppVersionCodeView.text = moduleRes.getString(R.string.various_install_app_info_version_code) + ": " + mAppVersionCode
                    mAppSdkView.text = moduleRes.getString(R.string.various_install_app_info_sdk) + ": " + mAppSdk
                    mAppSizeView.text = moduleRes.getString(R.string.various_install_app_size) + ": " + mOldAppSize + mNewAppSize
