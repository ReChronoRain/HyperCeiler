...
public class MainFragment extends SettingsPreferenceFragment {
    ...
    public void initPrefs() {
        ...
        if (randomTip == 1) mTip.setSummary(getString(R.string.tip_a) + " " + getString(R.string.tip_1));
        else if (randomTip == 2) mTip.setSummary(getString(R.string.tip_a) + " " + getString(R.string.tip_2));
        else if (randomTip == 3) mTip.setSummary(getString(R.string.tip_a) + " " + getString(R.string.tip_3));
        else if (randomTip == 4) mTip.setSummary(getString(R.string.tip_a) + " " + getString(R.string.tip_4));
        else if (randomTip == 5) mTip.setSummary(getString(R.string.tip_a) + " " + getString(R.string.tip_5));
        else if (randomTip == 6) mTip.setSummary(getString(R.string.tip_a) + " " + getString(R.string.tip_6));
        else if (randomTip == 7) mTip.setSummary(getString(R.string.tip_a) + " " + getString(R.string.tip_7));
        else if (randomTip == 8) mTip.setSummary(getString(R.string.tip_a) + " " + getString(R.string.tip_8));
        else if (randomTip == 9) mTip.setSummary(getString(R.string.tip_a) + " " + getString(R.string.tip_9));
        else if (randomTip == 10) mTip.setSummary(getString(R.string.tip_a) + " " + getString(R.string.tip_10));
        else if (randomTip == 11) mTip.setSummary(getString(R.string.tip_a) + " " + getString(R.string.tip_11));
        else if (randomTip == 12) mTip.setSummary(getString(R.string.tip_a) + " " + getString(R.string.tip_12));
        else if (randomTip == 13) mTip.setSummary(getString(R.string.tip_a) + " " + getString(R.string.tip_13));
