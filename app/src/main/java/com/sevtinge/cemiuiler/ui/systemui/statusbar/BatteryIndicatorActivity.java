    ...
    public static class BatteryIndicatorFragment extends SubFragment {
        ...
        public void initPrefs() {
            ...
            mBatteryindicatorTest.setOnPreferenceClickListener(preference -> {
                getActivity().sendBroadcast(new Intent("moralnorm.module.BatteryIndicatorTest"));
                return true;
            });
        }

        private void showBatteryIndicatorColor(int vavle) {
            boolean showBatteryIndicatorColor = vavle != 2;
