 ...
 */
package com.sevtinge.hyperceiler.oldui.main.page.about.controller;

import static com.sevtinge.hyperceiler.oldui.main.fragment.ContentFragment.mCurrTab;
...
import com.sevtinge.hyperceiler.oldui.main.model.TabViewModel;
...
public class LogoAnimationController {
    ...
    public void iniData(Context context, boolean needUpdate) {
        mContext = context;
        actionBarPadding = getDimensionPixelSize(R.dimen.app_logo_area_height) - getDimensionPixelSize(fan.appcompat.R.dimen.miuix_appcompat_action_bar_default_height);
