...
public abstract class PageFragment extends PreferenceFragment {
    ...
    public int getThemeRes() {
        return com.sevtinge.hyperceiler.ui.R.style.Theme_Navigator_ContentChild_Home;
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        if (getThemeRes() != 0) setThemeRes(com.sevtinge.hyperceiler.ui.R.style.AppTheme);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mNestedHeaderLayout = mRootView.findViewById(com.sevtinge.hyperceiler.R.id.nested_header_layout);
