...
import com.sevtinge.hyperceiler.module.hook.systemsettings.UnlockXiaomiHyperAIEntrance;
...
@HookBase(targetPackage = "com.android.settings", isPad = 2, targetSdk = 35)
