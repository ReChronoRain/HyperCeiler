        ...
        findAndHookMethod(
            ...
            object : MethodHook() {
                override fun before(param: MethodHookParam) {
                    ...
                    val stealth =
                        slotName == "stealth" && mPrefsMap.getBoolean("system_ui_status_bar_hide_icon_stealth")
                    val mute =
                        slotName == "mute" && mPrefsMap.getBoolean("system_ui_status_bar_hide_icon_mute")
                    val speakerphone =
                        slotName == "speakerphone" && mPrefsMap.getBoolean("system_ui_status_bar_hide_icon_speakerphone")
                    val call_record =
                        slotName == "call_record" && mPrefsMap.getBoolean("system_ui_status_bar_hide_icon_call_record")
