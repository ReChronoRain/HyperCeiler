...
class BackgroundBlurDrawable : IXposedHookZygoteInit {
    override fun initZygote(startupParam: IXposedHookZygoteInit.StartupParam) {
        ...
        val mBackgroundBlurDrawableClass = classLoader?.let {
            XposedHelpers.findClassIfExists("com.android.internal.graphics.drawable.BackgroundBlurDrawable", it)
        } ?: return
            ...
            object : XC_MethodHook() {
                override fun beforeHookedMethod(param: MethodHookParam) {
                    ...
                    if (!canvas.isHardwareAccelerated) {
                        XposedLogUtils.logI("BackgroundBlurDrawable", "android", "BackgroundBlurDrawable canvas is not HardwareAccelerated.")
                        param.result = null
                    }
                }
            })
