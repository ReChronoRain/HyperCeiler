...
public class CrashService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        AndroidLogUtils.LogI(TAG.TAG, "service create");
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        AndroidLogUtils.LogI(TAG.TAG, "service onStartCommand");
        ...
        ShellUtils.OpenShellExecWindow open = new ShellUtils.OpenShellExecWindow(
            ...
            public void readOutput(String out, String type) {
                AndroidLogUtils.LogE(TAG.TAG, "S O: " + out + " T: " + type, null);
            }
        };
        int re = open.getResult();
        open.close();
        AndroidLogUtils.LogI(TAG.TAG, "R: " + re + " C: " + cover + " E: " + equal);
        if (equal) {
    ...
    public void onDestroy() {
        AndroidLogUtils.LogI(TAG.TAG, "service onDestroy");
        super.onDestroy();
    }
}
