...
import fan.viewpager2.adapter.StatefulAdapter;
...
public class ViewPager2 extends ViewGroup {
    ...
    fan.recyclerview.widget.RecyclerView mRecyclerView;
    ...
    void setCurrentItemInternal(int item, boolean smoothScroll, boolean z2) {
     ...
     */
    private class RecyclerViewImpl extends fan.recyclerview.widget.RecyclerView {

        private float initX;
        private float initY;
        private int mTouchSlop;
        private boolean mIsScrolledX = false;
        private boolean mIsScrolledY = false;
            ...
            if (isUserInputEnabled()) {
                switch (ev.getActionMasked()) {
                    ...
                    case MotionEvent.ACTION_MOVE -> {
                        float abs = Math.abs(ev.getX() - initX);
                        float abs2 = Math.abs(ev.getY() - initY);
                        if (abs > mTouchSlop && abs * 0.5f > abs2 && !mIsScrolledY) {
                            mIsScrolledX = true;
    ...
    public void setSpringEnabled(boolean z) {
        mRecyclerView.setSpringEnabled(z);
    }
